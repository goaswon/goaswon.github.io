...
- 빅데이터에서 가치를 추출하기 위해 일련의 과정(수집 :arrow_right: 저장 :arrow_right: 처리 :arrow_right: 분석 :arrow_right: 시각화)을 규격화한 기술
...
1. Map Reduce
   ...
   - Key :arrow_right: Value 형태의 데이터 처리

   - Map :arrow_right: Shuffle :arrow_right: Reduce 순서대로 데이터 처리
